...
Green1Data:
	db 51,SQUIRTLE,0 ; HACK
	db 51,BULBASAUR,0 ; HACK
	db 51,CHARMANDER,0 ; HACK
	db $FF,51,PIDGEY,51,SQUIRTLE,0 ; HACK
	db $FF,9,PIDGEY,8,BULBASAUR,0 ; HACK
	db $FF,9,PIDGEY,8,CHARMANDER,0 ; HACK
	db $FF,53,PIDGEOTTO,52,ABRA,52,RATTATA,53,SQUIRTLE,0  ; HACK
	db $FF,53,PIDGEOTTO,52,ABRA,52,RATTATA,53,BULBASAUR,0 ; HACK
	db $FF,53,PIDGEOTTO,52,ABRA,52,RATTATA,53,CHARMANDER,0 ; HACK
ProfOakData:
...
GiovanniData:
	...
	db $FF,60,RHYHORN,60,DUGTRIO,60,NIDOQUEEN,60,NIDOKING,60,RHYDON,0 ; HACK
RocketData:
...
BrockData:
	db $FF,60,GEODUDE,60,ONIX,60,GOLEM,60,RHYHORN,60,OMANYTE,60,AERODACTYL,0 ; HACK
MistyData:
	db $FF,60,STARYU,60,STARMIE,0 ; HACK
LtSurgeData:
	db $FF,60,VOLTORB,60,PIKACHU,60,RAICHU,0 ; HACK
ErikaData:
	db $FF,60,VICTREEBEL,60,TANGELA,60,VILEPLUME,0 ; HACK
KogaData:
	db $FF,60,KOFFING,60,MUK,60,KOFFING,60,WEEZING,0 ; HACK
BlaineData:
	db $FF,60,GROWLITHE,60,PONYTA,60,RAPIDASH,60,ARCANINE,0 ; HACK
SabrinaData:
	db $FF,60,KADABRA,60,MR_MIME,60,VENOMOTH,60,ALAKAZAM,0 ; HACK
GentlemanData:
